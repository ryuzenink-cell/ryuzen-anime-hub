...
const PUBLIC_VERSION = "20260719-user-accounts-v2";
...
expect(serviceWorker.includes('v2.1.0-avatars'), "O service worker deve invalidar caches após a correção resiliente da descoberta pública.");
expect(serviceWorker.includes('/assets/js/api.js?v=20260719-user-accounts-v2'), "O service worker deve pré-cachear a versão nova do cliente da API.");
...
expect(ui.includes("icons/icon-192.png?v=20260719-user-accounts-v2"), "A marca no cabeçalho deve reutilizar ícone otimizado e versionado.");

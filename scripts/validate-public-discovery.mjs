...
const PUBLIC_VERSION = "20260724-discovery-fix-v1";
...
expect(serviceWorker.includes('v2.2.0-discovery-fix'), "O service worker deve invalidar caches após a correção resiliente da descoberta pública.");
expect(serviceWorker.includes('/assets/js/api.js?v=20260724-discovery-fix-v1'), "O service worker deve pré-cachear a versão nova do cliente da API.");
...
expect(ui.includes("icons/icon-192.png?v=20260724-discovery-fix-v1"), "A marca no cabeçalho deve reutilizar ícone otimizado e versionado.");

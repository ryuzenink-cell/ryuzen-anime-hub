...
const PUBLIC_VERSION = "20260724-status-banner-v2";
...
expect(serviceWorker.includes('/assets/js/api.js?v=20260724-status-banner-v2'), "O service worker deve pré-cachear a versão nova do cliente da API.");
...
expect(ui.includes("icons/icon-192.png?v=20260724-status-banner-v2"), "A marca no cabeçalho deve reutilizar ícone otimizado e versionado.");

...
expect(home.includes("20260724-status-banner-v2") && serviceWorker.includes("v2.3.0-status-banner"), "A home pública deve permanecer versionada e o service worker deve invalidar caches após atualizações públicas.");

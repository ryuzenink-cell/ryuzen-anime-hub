...
expect(home.includes("20260719-user-accounts-v2") && serviceWorker.includes("v2.1.0-avatars"), "A home pública deve permanecer versionada e o service worker deve invalidar caches após atualizações públicas.");
